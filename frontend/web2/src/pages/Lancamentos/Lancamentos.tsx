...
export default function Lancamentos() {
    ...
    return (
        <div
            className="application-content lancamentos"
        >
            <LeftSideToolBar />
            ...
            {loadingState ?
                ...
                <div className="application-body" >
                    ...
                    {Distinct(purchases?.map(p => ({ id: p.classificacaoFinal.id, descricao: p.classificacaoFinal.descricao })))
                        .map(grupo =>
                            <fieldset key={grupo.id}>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        {purchases?.filter(i => i.classificacaoFinal.id === grupo.id)
                                        ...
                                        <tr>
                                            <td colSpan={4} className='total'>
                                                {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' })
                                                    .format(purchases?.filter(i => i.descricaoExtra ? i.descricaoExtra.classificacao.descricao === grupo.descricao : i.estabelecimento.classificacao.descricao === grupo.descricao)
